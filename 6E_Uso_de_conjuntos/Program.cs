...
namespace _6E_Uso_de_conjuntos
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            HashSet<string> Union2 = new HashSet<string>(C);
            Union2.UnionWith(D);
            HashSet<string> Inter2 = new HashSet<string>(C);
            Inter2.IntersectWith(D);
            HashSet<string> Dif2 = new HashSet<string>(C);
            Dif2.ExceptWith(D);
            HashSet<string> DifS2 = new HashSet<string>(C);
            DifS2.SymmetricExceptWith(D);

            HashSet<string> Union3 = new HashSet<string>(E);
            Union3.UnionWith(F);
            HashSet<string> Inter3 = new HashSet<string>(E);
            Inter3.IntersectWith(F);
            HashSet<string> Dif3 = new HashSet<string>(E);
            Dif3.ExceptWith(F);
            HashSet<string> DifS3 = new HashSet<string>(E);
            DifS3.SymmetricExceptWith(F);
